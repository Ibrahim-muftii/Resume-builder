...
export function DownloadButton({ resume, templateId }: DownloadButtonProps) {
  ...
  return (
    <PDFDownloadLink document={<ResumePDF resume={resume} templateId={templateId} />} fileName={filename}>
      {({ loading }) => (
        <span className="inline-flex items-center justify-center rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm font-medium text-zinc-900 hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:bg-zinc-800">
